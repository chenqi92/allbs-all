...
import cn.allbs.admin.config.utils.beans.AllbsBeanCopier;
import cn.allbs.admin.config.utils.beans.AllbsBeanMap;
import cn.allbs.admin.config.utils.beans.BeanDiff;
import cn.allbs.admin.config.utils.beans.BeanProperty;
import cn.allbs.admin.config.utils.convert.AllbsConverter;
...
public class BeanUtil extends org.springframework.beans.BeanUtils {
    ...
    public static <T> T copy(@Nullable Object source, Class<?> sourceClazz, Class<T> targetClazz) {
        ...
        AllbsBeanCopier copier = AllbsBeanCopier.create(sourceClazz, targetClazz, false);
    ...
    public static void copy(@Nullable Object source, @Nullable Object targetBean) {
        ...
        AllbsBeanCopier copier = AllbsBeanCopier
    ...
    public static <T> T copyWithConvert(@Nullable Object source, Class<?> sourceClazz, Class<T> targetClazz) {
        ...
        AllbsBeanCopier copier = AllbsBeanCopier.create(sourceClazz, targetClazz, true);
        T to = newInstance(targetClazz);
        copier.copy(source, to, new AllbsConverter(sourceClazz, targetClazz));
        return to;
    }
    ...
    public static Map<String, Object> toMap(@Nullable Object bean) {
        ...
        return AllbsBeanMap.create(bean);
    }
