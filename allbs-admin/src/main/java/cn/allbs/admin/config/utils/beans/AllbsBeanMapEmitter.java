...
/**
 * 类 AllbsBeanMapEmitter
 *
 * @author ChenQi
 * @date 2024/4/1
 */
public class AllbsBeanMapEmitter extends ClassEmitter {

    private static final Type BEAN_MAP = TypeUtils.parseType(AllbsBeanMap.class.getName());
    ...
    public AllbsBeanMapEmitter(ClassVisitor v, String className, Class type, int require) {
        super(v);
